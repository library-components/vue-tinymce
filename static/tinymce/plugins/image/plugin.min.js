...
!(function () {
  ...
  function q (e) {
    return (
      Ue.getAttrib(e, 'alt').length === 0 &&
      Ue.getAttrib(e, 'role') === 'presentation'
    )
  }
  function Q () {
    return {
  ...
  function ie (n, e) {
    var r,
      ...
      o = i.getParent(
        e.parentNode,
        function (e) {
          return h((t = a), (n = e.nodeName)) && t[n] != null
          var t, n
        },
        n.getBody()
      )
  ...
  function ge (l, s, t, c) {
    ...
    ((e = n.fileinput).length > 0 ? L.some(e[0]) : L.none()).fold(
      function () {
        c.unblock()
      },
      function (n) {
  ...
  o.add('image', function (e) {
    ...
    n.ui.registry.addContextMenu('image', {
      update: function (e) {
        return Z(e) || (e.nodeName === 'IMG' && !E(e)) ? ['image'] : []
      }
    }),
